...
export const CreatePost = () => {
  ...
  return (
    <div className='h-[80vh] flex flex-col items-center justify-center gap-3'>
      <h1 className='text-3xl font-bold text-gray-500'>CreatePost</h1>
      <form className='flex flex-col justify-center items-center gap-3'>
        ...
        <input className='border-2 border-black px-3 py-2' type="text" placeholder='image url' value={image}  onChange={(e)=>{setTitle(e.target.value)}} required/>
